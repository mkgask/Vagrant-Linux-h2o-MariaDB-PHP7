...
chown -R ubuntu:ubuntu #{dir_user_home}.phpenv
EOH
...
cp #{dir_tmp}/php-build/source/#{php_version}/sapi/fpm/init.d.php-fpm #{dir_tmp}/php-build/source/#{php_version}/sapi/fpm/init.d.php-fpm.edit
sed -i 's%${prefix}%#{dir_user_home}.phpenv/versions/#{php_version}%' #{dir_tmp}/php-build/source/#{php_version}/sapi/fpm/init.d.php-fpm.edit
sed -i 's%${exec_prefix}%#{dir_user_home}.phpenv/versions/#{php_version}%' #{dir_tmp}/php-build/source/#{php_version}/sapi/fpm/init.d.php-fpm.edit
mv #{dir_tmp}/php-build/source/#{php_version}/sapi/fpm/init.d.php-fpm.edit /etc/init.d/php-fpm
